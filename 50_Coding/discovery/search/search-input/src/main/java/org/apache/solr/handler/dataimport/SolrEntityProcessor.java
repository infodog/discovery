...
/**
 * <p>
 * An implementation of {@link org.apache.solr.handler.dataimport.EntityProcessor} which fetches values from a
...
public class SolrEntityProcessor extends EntityProcessorBase {
  ...
  /**
   * Factory method that returns a {@link org.apache.http.client.HttpClient} instance used for interfacing with a source Solr service.
   * One can override this method to return a differently configured {@link org.apache.http.client.HttpClient} instance.
   * For example configure https and http authentication.
   *
   * @return a {@link org.apache.http.client.HttpClient} instance used for interfacing with a source Solr service
   */
