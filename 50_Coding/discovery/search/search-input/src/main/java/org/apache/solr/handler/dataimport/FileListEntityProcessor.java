...
/**
 * <p>
 * An {@link org.apache.solr.handler.dataimport.EntityProcessor} instance which can stream file names found in a given base
 ...
 * </ul>
 * Its output can be used along with {@link org.apache.solr.handler.dataimport.FileDataSource} to read from files in file
 * systems.
 * </p>
 * <p/>
 * <p>
