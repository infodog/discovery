...
/**
 * <p> An implementation of {@link org.apache.solr.handler.dataimport.EntityProcessor} which uses a streaming xpath parser to extract values out of XML documents.
 * It is typically used in conjunction with {@link org.apache.solr.handler.dataimport.URLDataSource} or {@link org.apache.solr.handler.dataimport.FileDataSource}. </p> <p/> <p> Refer to <a
