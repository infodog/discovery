...
/**
 * <p> {@link org.apache.solr.handler.dataimport.DocBuilder} is responsible for creating Solr documents out of the given configuration. It also maintains
...
public class DocBuilder {
    ...
    public VariableResolverImpl getVariableResolver() {
        try {
            ...
            String pigeonKey = "pigeon." + PIGEON_LAST_VERSION;
            String version = persistedProperties.getProperty(pigeonKey);
            if (version != null) {
                indexerNamespace.put(pigeonKey, version);
            }
        ...
        try {
            ...
            for (EntityProcessorWrapper epw : epwList) {
                ...
                if (dataImporter.getStatus() == DataImporter.Status.RUNNING_DELTA_DUMP) {
                    ...
                    System.out.println("deleteQuery:" + delQuery);
                ...
                // Pigeon version
                lastIndexTimeProps.setProperty(epw.getEntity().getName() + "." + PIGEON_LAST_VERSION, String.valueOf(epw.getContext().getSessionAttribute(PIGEON_LAST_VERSION, Context.SCOPE_GLOBAL)));
    ...
    private void finish(Properties lastIndexTimeProps) {
        ...
        try {
            ...
            System.out.println("persist LastIndexTimeProps");
            System.out.println(lastIndexTimeProps);
        } catch (Exception e) {
    ...
    public static final String PIGEON_LAST_VERSION = "last_version";
}
