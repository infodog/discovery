...
public abstract class SolrSpellChecker {
  ...
  /**
   * Get the value of {@link org.apache.solr.common.params.SpellingParams#SPELLCHECK_ACCURACY} if supported.
   ...
   * The {@link org.apache.solr.spelling.SpellingResult#getSuggestions()} suggestions must be ordered by best suggestion first.
   * <p/>
   *
   * @param options The {@link org.apache.solr.spelling.SpellingOptions} to use
   * @return The {@link org.apache.solr.spelling.SpellingResult} suggestions
   * @throws java.io.IOException if there is an error producing suggestions
   */
