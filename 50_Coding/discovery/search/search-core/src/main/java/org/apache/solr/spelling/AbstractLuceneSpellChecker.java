...
public abstract class AbstractLuceneSpellChecker extends SolrSpellChecker {
  ...
  public static final String FREQ_COMP = "freq";
    ...
    //TODO Discovery
    public static final String CHINESE_SPELL = "chinese";
  ...
  * */
  ...
  public String init(NamedList config, SolrCore core) {
    ...
    if (accuracy != null) {
      ...
      //TODO Discovery
      try {
          chinese = (String) config.get(CHINESE_SPELL);
          if (chinese !=null && "on".equals(chinese)) {
              this.spellChecker.setChinese(true);
              log.info("using chinese spellchecker");
          }
      }catch (Exception e) {
          e.printStackTrace();
      }
