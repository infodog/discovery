 ...
 */
public class JSONColsResponseWriter implements QueryResponseWriter {
    ...
    public void write(Writer writer, SolrQueryRequest req, SolrQueryResponse rsp) throws IOException {
        ...
        try {
            String[] chart_fields = req.getParams().getParams(InsightParams.INSIGHT_CHART_FIELDS);
            ...
            rsp.getValues().add("fields", fields);
            rsp.getValues().add("columns",columns);

            rsp.getValues().add("init_offset", 0);
            rsp.getValues().add("review", false);
