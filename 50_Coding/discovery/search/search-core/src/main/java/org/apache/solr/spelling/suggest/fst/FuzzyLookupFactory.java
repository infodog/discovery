...
/**
 * Factory for {@link org.apache.lucene.search.suggest.analyzing.FuzzySuggester}
 * @lucene.experimental
 */
public class FuzzyLookupFactory extends LookupFactory {

  /**
   * Maximum number of edits allowed, used by {@link org.apache.lucene.util.automaton.LevenshteinAutomata#toAutomaton(int)}
   */
