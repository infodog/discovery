 ...
 * Time: 10:08 AM
 */
public abstract class InsightTextResponseWriter {
    ...
    public InsightTextResponseWriter(Writer writer,IndexSchema schema, SolrParams params, NamedList values, ReturnFields returnFields, int offset, int limit) {
        this.writer = FastWriter.wrap(writer);
        String indent = params.get("indent");
        this.schema = schema;
        this.params = params;
        this.values = values;
