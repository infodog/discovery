...
public class SuggestWordScoreComparator implements Comparator<SuggestWord> {
  ...
  /**
   * Creates a new comparator that will compare by {@link org.apache.lucene.search.spell.SuggestWord#score},
   * then by {@link org.apache.lucene.search.spell.SuggestWord#freq}, then by {@link org.apache.lucene.search.spell.SuggestWord#string}.
   */
