...
public class WordBreakSpellChecker {
   ...
   * 
   * @param suggestMode
   *          - default = {@link org.apache.lucene.search.spell.SuggestMode#SUGGEST_WHEN_NOT_IN_INDEX}
   * @param sortMethod
   *          - default =
   ...
   * single words. The returned {@link org.apache.lucene.search.spell.CombineSuggestion} contains both a
   * {@link org.apache.lucene.search.spell.SuggestWord} and also an array detailing which passed-in terms were
   ...
   * array {@link org.apache.lucene.search.spell.CombineSuggestion#originalTermIndexes}. Generally, a
   ...
   * {@link org.apache.lucene.search.spell.WordBreakSpellChecker#SEPARATOR_TERM}
   * </p>
   * <p>
   * When suggestMode equals {@link org.apache.lucene.search.spell.SuggestMode#SUGGEST_WHEN_NOT_IN_INDEX}, each
   * suggestion will include at least one term not in the index.
   * </p>
   * <p>
   * When suggestMode equals {@link org.apache.lucene.search.spell.SuggestMode#SUGGEST_MORE_POPULAR}, each
   ...
   * {@link org.apache.lucene.search.spell.SuggestMode#SUGGEST_MORE_POPULAR}
   * </p>
   * 
