...
public class FSTCompletion {
  ...
  public static final class Completion implements Comparable<Completion> {
    ...
    /** @see org.apache.lucene.util.BytesRef#compareTo(org.apache.lucene.util.BytesRef) */
    @Override
  ...
  /**
   * An empty result. Keep this an {@link java.util.ArrayList} to keep all the returned
  ...
  /**
   * @see #FSTCompletion(org.apache.lucene.util.fst.FST, boolean, boolean)
   */
  ...
  private int getExactMatchStartingFromRootArc(
    ...
    try {
      final Arc<Object> scratch = new Arc<Object>();
      FST.BytesReader fstReader = automaton.getBytesReader();
  ...
  private ArrayList<Completion> lookupSortedByWeight(BytesRef key, 
    ...
    for (int i = 0; i < rootArcs.length; i++) {
      ...
      final Arc<Object> arc = new Arc<Object>().copyFrom(rootArc);
