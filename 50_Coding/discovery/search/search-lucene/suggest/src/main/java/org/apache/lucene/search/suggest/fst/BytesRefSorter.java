...
/**
 * Collects {@link org.apache.lucene.util.BytesRef} and then allows one to iterate over their sorted order. Implementations
...
public interface BytesRefSorter {
  ...
  /**
   * Sorts the entries added in {@link #add(org.apache.lucene.util.BytesRef)} and returns
