...
public abstract class Lookup {
  ...
  /**
   * A {@link org.apache.lucene.util.PriorityQueue} collecting a fixed size of high priority {@link org.apache.lucene.search.suggest.Lookup.LookupResult}
   */
  ...
  /**
   * Builds up a new internal {@link org.apache.lucene.search.suggest.Lookup} representation based on the given {@link org.apache.lucene.search.spell.TermFreqIterator}.
   ...
   * @param output {@link java.io.OutputStream} to write the data to.
   * @return true if successful, false if unsuccessful or not supported.
   * @throws java.io.IOException when fatal IO error occurs.
   */
   ...
   * Optional operation.
   * @param input the {@link java.io.InputStream} to load the lookup data.
