...
public class AnalyzingSuggester extends Lookup {
   ...
   *  #AnalyzingSuggester(org.apache.lucene.analysis.Analyzer, org.apache.lucene.analysis.Analyzer,int,int,int)} to always
  ...
  /** Include this flag in the options parameter to {@link
   *  #AnalyzingSuggester(org.apache.lucene.analysis.Analyzer, org.apache.lucene.analysis.Analyzer,int,int,int)} to preserve
  ...
  /**
   * Calls {@link #AnalyzingSuggester(org.apache.lucene.analysis.Analyzer, org.apache.lucene.analysis.Analyzer,int,int,int)
