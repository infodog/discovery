...
/**
 * An adapter from {@link Lookup} API to {@link org.apache.lucene.search.suggest.fst.FSTCompletion}.
 * 
 * <p>This adapter differs from {@link org.apache.lucene.search.suggest.fst.FSTCompletion} in that it attempts
 * to discretize any "weights" as passed from in {@link org.apache.lucene.search.spell.TermFreqIterator#weight()}
 * to match the number of buckets. For the rationale for bucketing, see
 * {@link org.apache.lucene.search.suggest.fst.FSTCompletion}.
 * 
 ...
 * use {@link org.apache.lucene.search.suggest.fst.FSTCompletion} directly or {@link TSTLookup}, for example.
 * 
 * @see org.apache.lucene.search.suggest.fst.FSTCompletion
 * @lucene.experimental
 */
public class FSTCompletionLookup extends Lookup {
   ...
   * 
   * @see #FSTCompletionLookup(org.apache.lucene.search.suggest.fst.FSTCompletion, boolean)
   */
   ...
   * automata at the cost of RAM for keeping nodes hash in the {@link org.apache.lucene.util.fst.FST}.
   *  
   * <p>Empirical pick.
   */
   ...
   * {@link #build(org.apache.lucene.search.spell.TermFreqIterator)} method. The number of weight
   * discretization buckets is set to {@link org.apache.lucene.search.suggest.fst.FSTCompletion#DEFAULT_BUCKETS} and
  ...
  /**
   * This constructor prepares for creating a suggested FST using the
   * {@link #build(org.apache.lucene.search.spell.TermFreqIterator)} method.
   * 
   * @param buckets
   *          The number of weight discretization buckets (see
   *          {@link org.apache.lucene.search.suggest.fst.FSTCompletion} for details).
   * 
   ...
   * 
   *  @param completion 
   *          An instance of {@link org.apache.lucene.search.suggest.fst.FSTCompletion}.
   *  @param exactMatchFirst
   *          If <code>true</code> exact matches are promoted to the top of the
   *          suggestions list. Otherwise they appear in the order of
   *          discretized weight and alphabetical within the bucket.
