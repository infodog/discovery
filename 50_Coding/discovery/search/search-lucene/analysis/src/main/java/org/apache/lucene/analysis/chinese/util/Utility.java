package org.apache.lucene.analysis.chinese.util;
...
public class Utility {
    ...
    /**
     * Delimiters will be filtered to this character by {@link org.apache.lucene.analysis.chinese.hhmm.SegTokenFilter}
     */
     ...
     * Otherwise, behave as {@link org.apache.lucene.analysis.chinese.util.Utility#compareArray(char[], int, char[], int)}
     *
     ...
     * @return 0 if shortArray is a prefix of longArray, otherwise act as {@link org.apache.lucene.analysis.chinese.util.Utility#compareArray(char[], int, char[], int)}
     */
