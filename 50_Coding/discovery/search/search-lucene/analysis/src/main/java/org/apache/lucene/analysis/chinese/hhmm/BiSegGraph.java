...
import org.apache.lucene.analysis.chinese.dictionary.BigramDictionary;
...
class BiSegGraph {
  ...
  /**
   * Return a {@link java.util.List} of all token pairs at this offset (index of the second token)
   * 
   * @param to index of the second token in the token pair
   * @return {@link java.util.List} of token pairs.
   */
