...
class Base
  ...
  ajax: (params, defaults) ->
    $.oajax($.extend({}, @defaults, defaults, params))

  queue: (callback) ->
    Oajax.queue(callback)
